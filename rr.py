...
if st.session_state.page == "registration":
    ...
    # ... (belt_options و egyptian_competitions و united_general_competitions و federation_champs كما هي)
    ...
    # ============== Other Championships ==============
        ...
        for i in range(num_players):
            ...
            with st.expander(f"Player {i+1}"):
                ...
                # ✅ إضافة Height و Weight لكل البطولات ما عدا Master Course
                height = st.number_input("Height (cm) / الطول (سم)", min_value=100, max_value=250, key=f"height{suffix}")
                weight = st.number_input("Weight (kg) / الوزن (كجم)", min_value=20, max_value=200, key=f"weight{suffix}")
